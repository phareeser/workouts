  ...
  def import_workouts(self, db):
    ...
    for data in self.json:
      ...
      for record in workouts:
        ...
        #cleanup / convert correctly starting here
        workout.distance_m = (record['distance'])
        workout.average_speed_m_per_sec = (record['averageSpeed'])
        workout.max_speed_m_per_sec = (record['maxSpeed'])
        ...
        workout.aerobic_training_effect = (record['aerobicTrainingEffect'])
        workout.anaerobic_training_effect = (record['anaerobicTrainingEffect'])
        ...
        workout.avg_vertical_oscillation = (record['avgVerticalOscillation'])
